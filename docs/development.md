...
**Note**: To install services [insight-api](https://github.com/proinvestcoin/proinvestcoin-insight-api) and [insight-ui](https://github.com/proinvestcoin/proinvestcoin-insight-ui) you'll need to clone the repositories locally.
